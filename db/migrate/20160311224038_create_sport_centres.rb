class CreateSportCentres < ActiveRecord::Migration
  def change
    create_table :sport_centres do |t|
    ...
    add_index(:sport_centres, :user_id)
    add_index(:sport_centres, :offer_id)
    add_index(:sport_centres, :location_id)
  end
end
